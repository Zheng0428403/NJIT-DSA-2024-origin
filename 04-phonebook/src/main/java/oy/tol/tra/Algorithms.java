...
public class Pair<K extends Comparable<K>, V> {
    ...
    public static <K extends Comparable<K>, V> void fastSort(Pair<K, V>[] sorted) {
     
        throw new UnsupportedOperationException("Unimplemented method 'fastSort'");
    }
}

public static <K extends Comparable<? super K>, V> void sort(Pair<? extends K, V>[] sorted) {
  Arrays.sort(sorted, (pair1, pair2) -> pair1.getKey().compareTo(pair2.getKey()));
}
